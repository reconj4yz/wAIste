  ...
  return (
    <div className="relative w-32 h-32 mx-auto mb-8">
      ...
      <div className="absolute inset-2 rounded-full bg-green-400 opacity-40 animate-ping"></div>
       <Image src="/w.png" alt="logo" width={135} height={135} />
      <div className="absolute inset-4 rounded-full bg-green-300 opacity-30 animate-spin"></div>
      <div className="absolute inset-6 rounded-full bg-green-200 opacity-20 animate-bounce"></div>
